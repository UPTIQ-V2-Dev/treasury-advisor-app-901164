...
export const RecommendationsPage = () => {
    ...
    const { data: recommendations = [], isLoading: recommendationsLoading } = useQuery({
        queryKey: ['recommendations', selectedClientId],
        queryFn: () => recommendationsService.getRecommendations(selectedClientId),
        enabled: !!selectedClientId
    });

    const { data: summary, isLoading: summaryLoading } = useQuery({
        queryKey: ['recommendation-summary', selectedClientId],
        queryFn: () => recommendationsService.getRecommendationSummary(selectedClientId),
        enabled: !!selectedClientId
    });
    ...
    return (
        <div className='space-y-6'>
            ...
            <div className='flex items-center justify-between'>
                <div>
                    <h1 className='text-3xl font-bold'>Client Treasury Recommendations</h1>
                    <p className='text-muted-foreground'>
                        AI-generated client-specific product suggestions based on financial analysis
                    </p>
                </div>
            ...
            <Card>
                <CardHeader>
                    ...
                    <CardDescription>Select a client to view their treasury product recommendations</CardDescription>
                </CardHeader>
                <CardContent>
                    <ClientSelector
                    ...
                    <CardContent className='flex items-center justify-center h-64'>
                        <div className='text-center space-y-4'>
                            ...
                            <div>
                                ...
                                <p className='text-muted-foreground'>
                                    Choose a client above to view their treasury recommendations
                                </p>
                            </div>
                        </div>
                    </CardContent>
                </Card>
            ) : recommendationsLoading || summaryLoading ? (
                ...
                <>
                    ...
                    >
                        <TabsList>
                            ...
                            <TabsTrigger value='high'>
                                High Priority ({filteredRecommendations.high.length})
                            </TabsTrigger>
                            <TabsTrigger value='pending'>
                                Pending ({filteredRecommendations.pending.length})
                            </TabsTrigger>
                            <TabsTrigger value='approved'>
                                Approved ({filteredRecommendations.approved.length})
                            </TabsTrigger>
                        </TabsList>
                                                    ...
                                                    {recommendation.rationale.supportingFactors.length > 0 && (
                                                        <div>
                                                            ...
                                                            <ul className='text-sm text-muted-foreground space-y-1'>
                                                                ...
                                                                {recommendation.rationale.supportingFactors.length >
                                                                    2 && (
                    ...
                    {selectedRecommendation && (
                        <Alert>
                            ...
                            <AlertDescription>
                                Detailed view for "{selectedRecommendation.product.name}" would open here. This will
                                show comprehensive rationale, implementation steps, and supporting data.
                            </AlertDescription>
                        </Alert>
                    )}
                </>
