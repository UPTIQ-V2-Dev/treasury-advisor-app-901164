...
import { agentValidation } from "../../validations/index.js";
...
router
    ...
    .post(auth('manageAgentTasks'), validate(agentValidation.createDocumentAnalysis), agentController.createDocumentAnalysis);
router
