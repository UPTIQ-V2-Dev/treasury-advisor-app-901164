...
router
    ...
    .get(auth('getStatements'), validate(statementValidation.getClientStatements), statementController.getClientStatements);
// Client bank connections
router
    .route('/:clientId/bank-connections')
    .get(auth('getStatements'), validate(statementValidation.getClientBankConnections), statementController.getClientBankConnections);
...
router
    ...
    .get(auth('getStatements'), validate(statementValidation.getConnectionStats), statementController.getConnectionStats);
