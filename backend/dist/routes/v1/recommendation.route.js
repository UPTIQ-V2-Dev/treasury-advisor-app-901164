 ...
 */
router.get('/:clientId', auth('getRecommendations'), validate(recommendationValidation.getByClientId), recommendationController.getRecommendationsByClientId);
/**
 * @swagger
 ...
 *         description: Internal server error
 */
router.post('/generate', auth('manageRecommendations'), validate(recommendationValidation.generate), recommendationController.generateRecommendations);
/**
 * @swagger
 ...
 *         description: Internal server error
 */
router.get('/detail/:recommendationId', auth('getRecommendations'), validate(recommendationValidation.getById), recommendationController.getRecommendationById);
/**
 * @swagger
 ...
 *         description: Internal server error
 */
router.post('/feedback', auth('manageRecommendations'), validate(recommendationValidation.feedback), recommendationController.provideFeedback);
/**
 * @swagger
 ...
 *         description: Internal server error
 */
router.post('/:recommendationId/approve', auth('manageRecommendations'), validate(recommendationValidation.approve), recommendationController.approveRecommendation);
/**
 * @swagger
 ...
 *         description: Internal server error
 */
router.post('/:recommendationId/reject', auth('manageRecommendations'), validate(recommendationValidation.reject), recommendationController.rejectRecommendation);
/**
 * @swagger
 ...
 *         description: Internal server error
 */
router.get('/summary/:clientId', auth('getRecommendations'), validate(recommendationValidation.getSummary), recommendationController.getRecommendationSummary);
/**
 * @swagger
 ...
 *         description: Internal server error
 */
router.patch('/:recommendationId/priority', auth('manageRecommendations'), validate(recommendationValidation.updatePriority), recommendationController.updateRecommendationPriority);
/**
 * @swagger
 ...
 *         description: Internal server error
 */
router.post('/:recommendationId/implement', auth('manageRecommendations'), validate(recommendationValidation.implement), recommendationController.implementRecommendation);
/**
 * @swagger
 ...
 *         description: Internal server error
 */
router.get('/export/:clientId', auth('getRecommendations'), validate(recommendationValidation.exportRecommendations), recommendationController.exportRecommendations);
/**
 * @swagger
 ...
 *         description: Internal server error
 */
router.get('/history/:clientId', auth('getRecommendations'), validate(recommendationValidation.getHistory), recommendationController.getHistoricalRecommendations);
