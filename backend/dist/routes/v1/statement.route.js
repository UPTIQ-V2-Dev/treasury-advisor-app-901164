...
import statementController, { upload } from "../../controllers/statement.controller.js";
...
router.route('/upload').post(auth('manageStatements'), upload.array('files', 10), // Allow up to 10 files
validate(statementValidation.uploadStatement), statementController.uploadStatements);
...
router
    .route('/:fileId/status')
    .get(auth('getStatements'), validate(statementValidation.getStatementStatus), statementController.getStatementStatus);
...
router
    .route('/connect')
    .post(auth('manageBankConnections'), validate(bankConnectionValidation.connectToBank), bankConnectionController.connectToBank);
...
router
    ...
    .patch(auth('manageStatements'), validate(statementValidation.validateStatement), statementController.updateStatement)
    .delete(auth('manageStatements'), validate(statementValidation.deleteStatement), statementController.deleteStatement);
...
router
    .route('/validate-bulk')
    .post(auth('manageStatements'), validate(statementValidation.validateBulkStatements), statementController.validateBulkStatements);
// Get processing queue status
router
    .route('/processing-queue')
    .get(auth('getStatements'), validate(statementValidation.getProcessingQueue), statementController.getProcessingQueue);
// Reprocess failed statements
router
    .route('/reprocess')
    .post(auth('manageStatements'), validate(statementValidation.reprocessStatements), statementController.reprocessStatements);
