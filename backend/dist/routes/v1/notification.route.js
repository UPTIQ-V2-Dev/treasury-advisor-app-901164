...
router
    .route('/stream')
    .get(auth('getNotifications'), validate(notificationValidation.getNotificationStream), notificationController.getNotificationStream);
// Notifications CRUD
router
    .route('/')
...
router
    ...
    .post(auth('manageNotifications'), validate(notificationValidation.markNotificationAsRead), notificationController.markNotificationAsRead);
