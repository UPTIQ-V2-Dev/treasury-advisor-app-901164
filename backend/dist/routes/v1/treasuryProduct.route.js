import { treasuryProductController } from "../../controllers/index.js";
import auth from "../../middlewares/auth.js";
import validate from "../../middlewares/validate.js";
import { treasuryProductValidation } from "../../validations/index.js";
...
router
    ...
    .get(auth('getProducts'), validate(treasuryProductValidation.getProductsByCategory), treasuryProductController.getProductsByCategory);
router
    .route('/risk/:riskLevel')
    .get(auth('getProducts'), validate(treasuryProductValidation.getProductsByRiskLevel), treasuryProductController.getProductsByRiskLevel);
// Eligibility and benefits calculation
router
    .route('/:productId/eligibility')
    .post(auth('getProducts'), validate(treasuryProductValidation.checkEligibility), treasuryProductController.checkProductEligibility);
router
    .route('/:productId/benefits')
    .post(auth('getProducts'), validate(treasuryProductValidation.calculateBenefits), treasuryProductController.calculateEstimatedBenefits);
