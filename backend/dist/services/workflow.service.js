...
import { WorkflowActivityType, WorkflowTaskPriority, WorkflowTaskStatus, WorkflowTaskType } from '../generated/prisma/index.js';
 ...
 */
const getWorkflowTasks = async (filter, options = {}) => {
 ...
 */
const getWorkflowTaskById = async (taskId) => {
 ...
 */
const completeWorkflowTask = async (taskId, completionData, userId, userName) => {
 ...
 * @returns {Promise<WorkflowAudit[]>}
 */
const getWorkflowAudit = async (clientId, filter = {}, options = {}) => {
    const page = options.page ?? 1;
 ...
 */
const generateNextSteps = (task, resolution) => {
    const nextSteps = [];
    // Generate next steps based on task type and resolution
 ...
 */
const generateNotifications = (task, resolution) => {
    const notifications = [];
