import { AgentTaskStatus, ConnectionStatus, ConnectionType, NotificationType, PrismaClient, Role, WorkflowActivityType, WorkflowTaskPriority, WorkflowTaskStatus, WorkflowTaskType } from '../generated/prisma/index.js';
...
async function main() {
    ...
    console.log('✅ Created sample treasury products:', [highYieldSavings.name, moneyMarket.name, treasuryBills.name, cd.name, creditFacility.name].join(', '));
    ...
    console.log('✅ Created sample notifications:', [notification1.id, notification2.id, notification3.id, notification4.id, notification5.id].join(', '));
