...
const getTransactionsTool = {
    ...
    description: 'Get transactions for a client with optional filtering by account, date ranges, categories, types, amounts, and counterparties. Supports advanced filtering and pagination.',
...
const getTransactionAnalyticsTool = {
    id: 'transaction_get_analytics',
    name: 'Get Transaction Analytics',
    description: 'Get comprehensive transaction analytics for a client including cash flow summary, category breakdown, transaction type analysis, and top counterparties',
    inputSchema: z.object({
        clientId: z.string(),
        accountId: z.string().optional(),
        startDate: z.string().optional(),
    ...
    outputSchema: z.object({
        ...
        counterpartyBreakdown: z.array(z.object({
            counterparty: z.string().nullable(),
            amount: z.number(),
            count: z.number(),
            isInflow: z.boolean()
...
const getTransactionsByAccountTool = {
...
const searchTransactionsByDescriptionTool = {
...
const getLargeTransactionsTool = {
...
const getTransactionsByCounterpartyTool = {
...
const getTransactionsByCategoryTool = {
