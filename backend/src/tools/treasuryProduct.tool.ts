...
const createTreasuryProductTool: MCPTool = {
...
const getProductCatalogTool: MCPTool = {
...
const updateTreasuryProductTool: MCPTool = {
...
const deleteTreasuryProductTool: MCPTool = {
...
const getProductsByCategoryTool: MCPTool = {
...
const getProductsByRiskLevelTool: MCPTool = {
    ...
    fn: async (inputs: { riskLevel: string }) => {
...
const checkProductEligibilityTool: MCPTool = {
    ...
    fn: async (inputs: {
        ...
        const clientData = pick(inputs, ['businessSegment', 'riskProfile', 'totalBalance', 'industry']) as {
            businessSegment: string;
            riskProfile: string;
            totalBalance?: number;
            industry?: string;
...
const calculateEstimatedBenefitsTool: MCPTool = {
    ...
    fn: async (inputs: {
        ...
        const clientData = pick(inputs, ['currentBalance', 'currentYieldRate', 'transactionVolume']) as {
            currentBalance: number;
            currentYieldRate?: number;
            transactionVolume?: number;
        };
