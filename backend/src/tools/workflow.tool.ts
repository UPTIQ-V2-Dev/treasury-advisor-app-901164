...
const getWorkflowTasksTool: MCPTool = {
    ...
    fn: async (inputs: {
        ...
        return await workflowService.getWorkflowTasks(filter as any, options);
    }
};

const getWorkflowTaskByIdTool: MCPTool = {
...
const completeWorkflowTaskTool: MCPTool = {
    ...
    fn: async (inputs: {
        ...
        return await workflowService.completeWorkflowTask(
            inputs.taskId,
            completionData,
            inputs.userId,
            inputs.userName
...
const createWorkflowTaskTool: MCPTool = {
    ...
    fn: async (inputs: {
        ...
        const taskData = {
            ...
            priority: inputs.priority as any,
...
const getWorkflowAuditTool: MCPTool = {
    ...
    fn: async (inputs: {
        ...
        const options = pick(inputs, ['page', 'limit', 'sortBy', 'sortType']);
        return await workflowService.getWorkflowAudit(inputs.clientId, filter as any, options);
    }
};

const createWorkflowAuditTool: MCPTool = {
    ...
    fn: async (inputs: {
        ...
        return await workflowService.createAuditEntry({
            activityType: inputs.activityType as any,
