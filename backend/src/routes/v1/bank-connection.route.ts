...
import { bankConnectionValidation } from '../../validations/index.ts';
...
router
    ...
    .post(
        ...
        validate(bankConnectionValidation.createBankConnection),
        bankConnectionController.createBankConnection
    )
    .get(
        auth('getBankConnections'),
        validate(bankConnectionValidation.getBankConnections),
        bankConnectionController.getBankConnections
    );
...
router
    ...
    .get(
        auth('getBankConnections'),
        validate(bankConnectionValidation.getBankConnection),
        bankConnectionController.getBankConnection
    )
    .patch(
        auth('manageBankConnections'),
        validate(bankConnectionValidation.updateBankConnection),
        bankConnectionController.updateBankConnection
    )
    .delete(
        auth('manageBankConnections'),
        validate(bankConnectionValidation.deleteBankConnection),
        bankConnectionController.deleteBankConnection
    );
...
router
    ...
    .post(
        auth('manageBankConnections'),
        validate(bankConnectionValidation.syncBankConnection),
        bankConnectionController.syncBankConnection
    );
