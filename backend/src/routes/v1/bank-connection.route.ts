...
router
    ...
    .get(
        auth('getStatements'),
        validate(statementValidation.queryBankConnections),
        statementController.getAllBankConnections
    );
...
router
    ...
    .get(
        auth('getStatements'),
        validate(statementValidation.syncBankConnection),
        statementController.getBankConnectionById
    )
    .patch(
        auth('manageStatements'),
        validate(statementValidation.updateBankConnection),
        statementController.updateBankConnection
    )
    .delete(
        auth('manageStatements'),
        validate(statementValidation.deleteBankConnection),
        statementController.deleteBankConnection
    );
...
router
    ...
    .post(
        auth('manageStatements'),
        validate(statementValidation.syncBankConnection),
        statementController.syncBankConnection
    );
...
router
    ...
    .post(
        auth('manageStatements'),
        validate(statementValidation.testBankConnection),
        statementController.testBankConnection
    );
