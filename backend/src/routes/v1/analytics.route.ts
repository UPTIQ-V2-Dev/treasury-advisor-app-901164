...
import { analyticsValidation } from '../../validations/index.ts';
...
router
    ...
    .get(
        auth('getAnalytics'),
        validate(analyticsValidation.getAnalyticsOverview),
...
router
    ...
    .get(
        auth('getAnalytics'),
        validate(analyticsValidation.getCashFlowAnalytics),
        analyticsController.getCashFlowAnalytics
    );
...
router
    ...
    .get(
        auth('getAnalytics'),
        validate(analyticsValidation.getCategoryAnalytics),
...
router
    ...
    .get(
        auth('getAnalytics'),
        validate(analyticsValidation.getLiquidityAnalytics),
        analyticsController.getLiquidityAnalytics
    );
...
router
    ...
    .get(
        auth('getAnalytics'),
        validate(analyticsValidation.getSpendingPatterns),
        analyticsController.getSpendingPatterns
    );
...
router
    ...
    .get(
        auth('getAnalytics'),
        validate(analyticsValidation.getAnalyticsSummary),
...
router
    ...
    .get(
        auth('getAnalytics'),
        validate(analyticsValidation.getVendorAnalytics),
