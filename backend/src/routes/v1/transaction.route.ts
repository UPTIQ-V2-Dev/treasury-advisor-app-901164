import { transactionController } from '../../controllers/index.ts';
import auth from '../../middlewares/auth.ts';
import validate from '../../middlewares/validate.ts';
import { transactionValidation } from '../../validations/index.ts';
...
router
    ...
    .get(
        auth('getTransactions'),
        validate(transactionValidation.getTransactionAnalytics),
...
router
    ...
    .get(
        auth('getTransactions'),
        validate(transactionValidation.getTransactionsByAccount),
