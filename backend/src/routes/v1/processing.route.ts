import { processingController } from '../../controllers/index.ts';
import auth from '../../middlewares/auth.ts';
import validate from '../../middlewares/validate.ts';
import { processingValidation } from '../../validations/index.ts';
...
router.get(
    '/tasks/:taskId',
    auth('getProcessing'),
    validate(processingValidation.getTaskById),
    processingController.getTaskById
);
...
router.get(
    ...
    auth('getProcessing'),
    validate(processingValidation.getClientTasks),
    processingController.getClientTasks
);
...
router.post(
    ...
    validate(processingValidation.startProcessing),
...
router.post(
    '/tasks/:taskId/cancel',
    auth('manageProcessing'),
    validate(processingValidation.cancelTask),
...
router.post(
    '/tasks/:taskId/retry',
    auth('manageProcessing'),
    validate(processingValidation.retryTask),
    processingController.retryTask
);
...
router.get(
    '/metrics',
    auth('getProcessing'),
    validate(processingValidation.getMetrics),
    processingController.getMetrics
);
...
router.get(
    ...
    auth('getProcessing'),
    validate(processingValidation.getClientHistory),
    processingController.getClientHistory
);
...
router.get(
    '/tasks/:taskId/stream',
    auth('getProcessing'),
    validate(processingValidation.getTaskStream),
    processingController.getTaskStream
);
...
router.get(
    '/tasks/:taskId/logs',
    auth('getProcessing'),
    validate(processingValidation.getTaskLogs),
    processingController.getTaskLogs
);
