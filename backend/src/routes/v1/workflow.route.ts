import { workflowController } from '../../controllers/index.ts';
import auth from '../../middlewares/auth.ts';
import validate from '../../middlewares/validate.ts';
import { workflowValidation } from '../../validations/index.ts';
...
router
    ...
    .post(
        auth('manageWorkflowTasks'),
        validate(workflowValidation.createWorkflowTask),
        workflowController.createWorkflowTask
    );
...
router
    ...
    .post(
        auth('manageWorkflowTasks'),
        validate(workflowValidation.completeWorkflowTask),
        workflowController.completeWorkflowTask
    );
